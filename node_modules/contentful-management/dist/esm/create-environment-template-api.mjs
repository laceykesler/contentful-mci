...
import { wrapEnvironmentTemplateCollection, wrapEnvironmentTemplate } from './entities/environment-template.mjs';
...
export { createEnvironmentTemplateApi };
//# sourceMappingURL=create-environment-template-api.mjs.map
