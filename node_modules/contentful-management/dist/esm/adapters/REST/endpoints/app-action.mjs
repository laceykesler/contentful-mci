...
const get = (http, params) => {
    return get$1(http, getAppActionUrl(params));
};
...
const getManyForEnvironment = (http, params) => {
    return get$1(http, getAppActionsEnvUrl(params), {
        params: normalizeSelect(params.query),
    });
};
const del = (http, params) => {
    return del$1(http, getAppActionUrl(params));
};
const create = (http, params, data) => {
    return post(http, getBaseUrl(params), data);
};
const update = (http, params, data) => {
    return put(http, getAppActionUrl(params), data);
};

export { create, del, get, getMany, getManyForEnvironment, update };
//# sourceMappingURL=app-action.mjs.map
