...
const create = (http, params, data) => {
    ...
    return post(http, `/spaces/${params.spaceId}/environments/${params.environmentId}/asset_keys`, postParams);
};

export { ValidationError, create };
//# sourceMappingURL=asset-key.mjs.map
