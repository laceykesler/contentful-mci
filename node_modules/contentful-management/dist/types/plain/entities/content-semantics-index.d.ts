...
import type { GetContentSemanticsIndexParams, GetManyContentSemanticsIndexParams, GetManyContentSemanticsIndexForEnvironmentParams, GetOrganizationParams } from '../../common-types';
export type ContentSemanticsIndexPlainClientAPI = {
     ...
     */
    getMany(params: OptionalDefaults<GetManyContentSemanticsIndexParams>): Promise<ContentSemanticsIndexCollectionProps>;
    /**
     ...
     * @returns A promise that resolves to a collection of ContentSemanticsIndex.
     */
    getManyForEnvironment(params: OptionalDefaults<GetManyContentSemanticsIndexForEnvironmentParams>): Promise<ContentSemanticsIndexCollectionProps>;
    /**
     ...
     */
    create(params: OptionalDefaults<GetOrganizationParams>, payload: CreateContentSemanticsIndexProps): Promise<ContentSemanticsIndexProps>;
    /**
