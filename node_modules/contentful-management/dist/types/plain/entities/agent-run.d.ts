...
export type AgentRunPlainClientAPI = {
     ...
     * @throws if the request fails or the AI Agent Run is not found.
     */
    resumeRun(params: OptionalDefaults<GetSpaceEnvironmentParams & {
        runId: string;
    }>, payload: AgentResumeRunPayload, headers?: Partial<RawAxiosRequestHeaders>): Promise<AgentGenerateResponse>;
};
