...
const get = (http, params) => {
    return get$1(http, getAppInstallationUrl(params), {
...
const upsert = (http, params, rawData, headers) => {
    ...
    return put(http, getAppInstallationUrl(params), data, {
        headers: {
            ...headers,
...
const del = (http, params) => {
    return del$1(http, getAppInstallationUrl(params));
};
...
export { del, get, getAppInstallationUrl, getForOrganization, getMany, upsert };
