import { post, get as get$1, put } from './raw.js';
...
const getManyForOrganization = (http, params) => {
    return get$1(http, `/organizations/${params.organizationId}/access_tokens`, {
        params: params.query,
    });
};

export { createPersonalAccessToken, get, getMany, getManyForOrganization, revoke };
