...
import { normalizeCursorPaginationResponse } from '../../../common-utils.js';
import { getUploadHttpClient } from '../../../upload-http-client.js';
import { put, post, del as del$1, get as get$2 } from './raw.js';
import { create as create$2 } from './upload.js';
import { normalizeSelect } from './utils.js';
import { create as create$1, createFromFiles as createFromFiles$1, createWithId as createWithId$1, get as get$1, getMany as getMany$1, processForAllLocales as processForAllLocales$1, processForLocale as processForLocale$1, update as update$1 } from './release-asset.js';

const get = (http, params, rawData, headers) => {
    if (params.releaseId) {
        return get$1(http, params);
    }
    return get$2(http, `/spaces/${params.spaceId}/environments/${params.environmentId}/assets/${params.assetId}`, {
        params: normalizeSelect(params.query),
        headers: headers ? { ...headers } : undefined,
    });
};
const getPublished = (http, params, rawData, headers) => {
    return get$2(http, `/spaces/${params.spaceId}/environments/${params.environmentId}/public/assets`, {
        params: normalizeSelect(params.query),
        headers: headers ? { ...headers } : undefined,
    });
};
const getMany = (http, params, rawData, headers) => {
    if (params.releaseId) {
        return getMany$1(http, params);
    }
    return get$2(http, `/spaces/${params.spaceId}/environments/${params.environmentId}/assets`, {
        params: normalizeSelect(params.query),
        headers: headers ? { ...headers } : undefined,
    });
};
...
const update = (http, params, rawData, headers) => {
    if (params.releaseId) {
        return update$1(http, params, rawData, headers ?? {});
    }
    const data = copy(rawData);
    delete data.sys;
    return put(http, `/spaces/${params.spaceId}/environments/${params.environmentId}/assets/${params.assetId}`, data, {
        headers: {
...
const del = (http, params) => {
    return del$1(http, `/spaces/${params.spaceId}/environments/${params.environmentId}/assets/${params.assetId}`);
};
const publish = (http, params, rawData) => {
    const payload = params.locales?.length ? { add: { fields: { '*': params.locales } } } : null;
    return put(http, `/spaces/${params.spaceId}/environments/${params.environmentId}/assets/${params.assetId}/published`, payload, {
        headers: {
            'X-Contentful-Version': rawData.sys.version ?? 0,
        },
    });
...
const unpublish = (http, params, rawData) => {
    if (params.locales?.length) {
        ...
        return del$1(http, `/spaces/${params.spaceId}/environments/${params.environmentId}/assets/${params.assetId}/published`);
    }
};
const archive = (http, params) => {
    return put(http, `/spaces/${params.spaceId}/environments/${params.environmentId}/assets/${params.assetId}/archived`);
};
const unarchive = (http, params) => {
    return del$1(http, `/spaces/${params.spaceId}/environments/${params.environmentId}/assets/${params.assetId}/archived`);
};
const create = (http, params, rawData) => {
    if (params.releaseId) {
        return create$1(http, params, rawData, {});
    }
    const data = copy(rawData);
    return post(http, `/spaces/${params.spaceId}/environments/${params.environmentId}/assets`, data);
};
const createWithId = (http, params, rawData) => {
    if (params.releaseId) {
        return createWithId$1(http, params, rawData, {});
    }
    const data = copy(rawData);
    return put(http, `/spaces/${params.spaceId}/environments/${params.environmentId}/assets/${params.assetId}`, data);
};
const createFromFiles = async (http, params, data) => {
    ...
    return Promise.all(Object.keys(file).map(async (locale) => {
        ...
        return create$2(httpUpload, params, file[locale]).then((upload) => {
            return {
                [locale]: {
                    contentType,
                    fileName,
...
const processForLocale = async (http, { asset, locale, options: { processingCheckRetries, processingCheckWait } = {}, ...params }) => {
    ...
    return put(http, `/spaces/${params.spaceId}/environments/${params.environmentId}/assets/${asset.sys.id}/files/${locale}/process`, null, {
        headers: {
...
export { archive, create, createFromFiles, createWithId, del, get, getMany, getManyWithCursor, getPublished, processForAllLocales, processForLocale, publish, unarchive, unpublish, update };
