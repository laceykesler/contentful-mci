...
const get = (http, params) => {
    return get$1(http, `/spaces/${params.spaceId}/scheduled_actions/${params.scheduledActionId}`, {
        params: {
...
const getMany = (http, params) => {
    return get$1(http, `/spaces/${params.spaceId}/scheduled_actions`, {
        params: normalizeSelect(params.query),
    });
};
const create = (http, params, data) => {
    return post(http, `/spaces/${params.spaceId}/scheduled_actions`, data);
};
const del = (http, params) => {
    return del$1(http, `/spaces/${params.spaceId}/scheduled_actions/${params.scheduledActionId}`, {
        params: {
            'environment.sys.id': params.environmentId,
        },
    });
...
const update = (http, params, data) => {
    return put(http, `/spaces/${params.spaceId}/scheduled_actions/${params.scheduledActionId}`, data, {
        params: {
