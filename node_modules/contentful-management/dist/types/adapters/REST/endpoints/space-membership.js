...
const getForOrganization = (http, params) => {
    return get$1(http, `/organizations/${params.organizationId}/space_memberships/${params.spaceMembershipId}`);
};
const getManyForOrganization = (http, params) => {
    return get$1(http, `/organizations/${params.organizationId}/space_memberships`, {
        params: params.query,
    });
};
...
export { create, createWithId, del, get, getForOrganization, getMany, getManyForOrganization, update };
