 ...
 * @internal
 */
export declare const wrapWorkflowDefinitionCollection: (makeRequest: MakeRequest, data: import("..").CollectionProp<WorkflowDefinitionProps>) => import("..").Collection<WorkflowDefinition, WorkflowDefinitionProps>;
export {};
