...
import type { MetaSysProps, DefaultElements, EntityMetaSysProps, MetadataProps, MakeRequest, CursorPaginatedCollectionProp } from '../common-types';
 ...
 * @internal
 */
export declare const wrapAssetCollection: (makeRequest: MakeRequest, data: import("..").CollectionProp<AssetProps<{}>>) => import("..").Collection<Asset, AssetProps<{}>>;
/**
 * @internal
 */
export declare const wrapAssetTypeCursorPaginatedCollection: (makeRequest: MakeRequest, data: CursorPaginatedCollectionProp<AssetProps<{}>>) => import("..").CursorPaginatedCollection<Asset, AssetProps<{}>>;
export {};
