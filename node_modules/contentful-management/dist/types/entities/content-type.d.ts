...
import type { BasicMetaSysProps, Collection, CursorPaginatedCollectionProp, DefaultElements, Link, MakeRequest, SysLink } from '../common-types';
...
type TaxonomyConceptValidationLink = Link<'TaxonomyConcept'> & {
    required?: boolean;
};
type TaxonomyConceptSchemeValidationLink = Link<'TaxonomyConceptScheme'> & {
    required?: boolean;
};
 ...
 * @internal
 */
export declare const wrapContentTypeCollection: (makeRequest: MakeRequest, data: import("..").CollectionProp<ContentTypeProps>) => Collection<ContentType, ContentTypeProps>;
/**
 * @internal
 */
export declare const wrapContentTypeCursorPaginatedCollection: (makeRequest: MakeRequest, data: CursorPaginatedCollectionProp<ContentTypeProps>) => import("..").CursorPaginatedCollection<ContentType, ContentTypeProps>;
export {};
