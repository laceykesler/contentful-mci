 ...
 * @internal
 */
export declare const wrapEditorInterfaceCollection: (makeRequest: MakeRequest, data: import("..").CollectionProp<EditorInterfaceProps>) => import("..").Collection<EditorInterface, EditorInterfaceProps>;
export {};
