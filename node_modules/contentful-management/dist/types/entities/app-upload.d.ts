 ...
 */
export declare const wrapAppUploadCollection: (makeRequest: MakeRequest, data: import("..").CollectionProp<AppUploadProps>) => import("..").Collection<AppUpload, AppUploadProps>;
export {};
