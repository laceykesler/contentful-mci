...
export default function createEnvironmentApi(makeRequest: MakeRequest): {
     ...
     *  ```
     */
    createAppActionCall(appDefinitionId: string, appActionId: string, data: CreateAppActionCallProps): Promise<import("./export-types").AppActionCall>;
    /**
     ...
     *  ```
     */
    createAppSignedRequest(appDefinitionId: string, data: CreateAppSignedRequestProps): Promise<import("./export-types").AppSignedRequest>;
    /**
     ...
     *  ```
     */
    createAppAccessToken(appDefinitionId: string, data: CreateAppAccessTokenProps): Promise<import("./export-types").AppAccessToken>;
    /**
     ...
     * ```
     */
    getFunctionsForEnvironment(appInstallationId: string, query?: AcceptsQueryOptions): Promise<import("./common-types").Collection<import("./export-types").FunctionProps, import("./export-types").FunctionProps>>;
    /**
    ...
    createTag(id: string, name: string, visibility?: TagVisibility): Promise<import("./export-types").Tag>;
    getTags(query?: BasicQueryOptions): Promise<import("./common-types").Collection<import("./export-types").Tag, import("./export-types").TagProps>>;
    getTag(id: string): Promise<import("./export-types").Tag>;
    /**
     ...
     * ```
     */
    getRelease(releaseId: string): Promise<import("./export-types").Release>;
    /**
     ...
     * ```
     */
    getReleases(query?: ReleaseQueryOptions): Promise<import("./common-types").CursorPaginatedCollection<import("./export-types").Release, import("./export-types").ReleaseProps>>;
    /**
     ...
     * ```
     */
    createRelease(payload: ReleasePayload): Promise<import("./export-types").Release>;
    /**
    ...
    updateRelease({ releaseId, payload, version, }: {
        ...
        version: number;
    }): Promise<import("./export-types").Release>;
    /**
    ...
    publishRelease({ releaseId, version }: {
        releaseId: string;
        version: number;
    }): Promise<import("./export-types").ReleaseAction<any>>;
    /**
    ...
    }): Promise<import("./common-types").Collection<import("./export-types").ReleaseAction<any>, import("./export-types").ReleaseActionProps<any>>>;
    getUIConfig(): Promise<{
        update: () => Promise<any & import("./export-types").UIConfigProps & {
            toPlainObject(): import("./export-types").UIConfigProps;
        }>;
    } & import("./export-types").UIConfigProps & {
        toPlainObject(): import("./export-types").UIConfigProps;
    }>;
    ...
    } & import("./export-types").UserUIConfigProps & {
        toPlainObject(): import("./export-types").UserUIConfigProps;
    }>;
    /**
    ...
    }): Promise<import("./common-types").CursorPaginatedCollection<import("./export-types").EnvironmentTemplateInstallation, import("./export-types").EnvironmentTemplateInstallationProps>>;
    /**
     ...
     * ```
     */
    getResourcesForResourceType(resourceTypeId: string, query?: ResourceQueryOptions): Promise<import("./common-types").CursorPaginatedCollectionProp<import("./export-types").ResourceProps>>;
    /**
     ...
     * ```
     */
    invokeAiAction(aiActionId: string, payload: AiActionInvocationType): Promise<import("./export-types").AiActionInvocation>;
    /**
    ...
    getAiActionInvocation({ aiActionId, invocationId, }: {
        aiActionId: string;
        invocationId: string;
    }): Promise<import("./export-types").AiActionInvocation>;
    /**
     ...
     *    })
     */
    getSemanticDuplicates(payload: GetSemanticDuplicatesProps): Promise<import("./export-types").SemanticDuplicates>;
    /**
     ...
     *    })
     */
    getSemanticRecommendations(payload: GetSemanticRecommendationsProps): Promise<import("./export-types").SemanticRecommendations>;
    /**
     ...
     *    })
     */
    getSemanticReferenceSuggestions(payload: GetSemanticReferenceSuggestionsProps): Promise<import("./export-types").SemanticReferenceSuggestions>;
    /**
     ...
     *    })
     */
    getSemanticSearch(payload: GetSemanticSearchProps): Promise<import("./export-types").SemanticSearch>;
    /**
     ...
     * ```
     */
    getAgent(agentId: string): Promise<import("./export-types").Agent>;
    /**
     ...
     * ```
     */
    getAgents(): Promise<import("./common-types").Collection<import("./export-types").Agent, import("./export-types").AgentProps>>;
    /**
     ...
     * ```
     */
    generateWithAgent(agentId: string, payload: AgentGeneratePayload): Promise<import("./export-types").AgentGenerateResponse>;
    /**
     ...
     * ```
     */
    getAgentRun(runId: string): Promise<import("./export-types").AgentRun>;
    /**
     ...
     * ```
     */
    getAgentRuns(query?: AgentRunQueryOptions): Promise<import("./common-types").Collection<import("./export-types").AgentRun, import("./export-types").AgentRunProps>>;
};
